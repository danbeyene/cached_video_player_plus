...
class CachedVideoPlayerPlusPlatform extends VideoPlayerPlatform {
  final MethodChannel _channel = const MethodChannel('cached_video_player_plus');

  /// Registers this class as the default instance of [VideoPlayerPlatform].
  static void registerWith() {
    VideoPlayerPlatform.instance = CachedVideoPlayerPlusPlatform();
  }
  ...
  Future<int?> create(DataSource dataSource) async {
    ...
    switch (dataSource.sourceType) {
      case DataSourceType.asset:
        ...
        args['uri'] = dataSource.asset; // Mapping for simplicity if handled by native
        break;
...
class CachedVideoPlayerPlusPlatformWithEvents extends CachedVideoPlayerPlusPlatform {
    /// Registers this class as the default instance of [VideoPlayerPlatform].
    static void registerWith() {
        VideoPlayerPlatform.instance = CachedVideoPlayerPlusPlatformWithEvents();
    }

    @override
    Stream<VideoEvent> videoEventsFor(int playerId) {
        return EventChannel('cached_video_player_plus/videoEvents$playerId')
